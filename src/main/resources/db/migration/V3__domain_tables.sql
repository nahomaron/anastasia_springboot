...
CREATE TABLE churches (
    church_id BIGINT PRIMARY KEY DEFAULT nextval('church_id_seq'),
...
CREATE TABLE members (
    ...
    first_name_t VARCHAR(128) NOT NULL,
    father_name_t VARCHAR(128) NOT NULL,
    grand_father_name_t VARCHAR(128) NOT NULL,
    mother_full_name_t VARCHAR(128) NOT NULL,
...
CREATE TABLE children (
    id BIGINT PRIMARY KEY DEFAULT nextval('child_id_seq'),
    tenant_id UUID NOT NULL,
    membership_number VARCHAR(64),
    church_number VARCHAR(64) NOT NULL,
    status VARCHAR(32) NOT NULL,
...
-- OAuth tokens
CREATE TABLE tokens (
    id INTEGER PRIMARY KEY DEFAULT nextval('tokens_seq'),
    token VARCHAR(500),
    jwt_id VARCHAR(64),
