...
public class ChildMapper {
    ...
    public Child_MemberDTO childEntityToDTO(Child_MemberEntity childMemberEntity) {
        ...
        return Child_MemberDTO.builder()
                ...
                .firstNameLocal(childMemberEntity.getFirstNameLocal())
                .fatherNameLocal(childMemberEntity.getFatherNameLocal())
                .grandFatherNameLocal(childMemberEntity.getGrandFatherNameLocal())
                .motherFullNameLocal(childMemberEntity.getMotherFullNameLocal())
    ...
    public Child_MemberSummaryResponse childEntityToSummaryResponse(Child_MemberEntity childMemberEntity, String language) {
        ...
        String fullNameLocal = joinNameParts(
                childMemberEntity.getFirstNameLocal(),
                childMemberEntity.getFatherNameLocal(),
                childMemberEntity.getGrandFatherNameLocal()
        );
