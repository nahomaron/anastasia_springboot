...
public class MemberMapper {
    ...
    public Adult_MemberDTO memberEntityToDTO(Adult_MemberEntity adultMemberEntity) {
        ...
        return Adult_MemberDTO.builder()
                ...
                .firstNameLocal(adultMemberEntity.getFirstNameLocal())
                .fatherNameLocal(adultMemberEntity.getFatherNameLocal())
                .grandFatherNameLocal(adultMemberEntity.getGrandFatherNameLocal())
                .motherFullNameLocal(adultMemberEntity.getMotherFullNameLocal())
                ...
                .spouseMembershipNumber(adultMemberEntity.getSpouseMembershipNumber())
    ...
    public Adult_MemberSummaryResponse memberEntityToSummaryResponse(Adult_MemberEntity adultMemberEntity, String language) {
        ...
        String fullNameLocal = joinNameParts(
                adultMemberEntity.getFirstNameLocal(),
                adultMemberEntity.getFatherNameLocal(),
                adultMemberEntity.getGrandFatherNameLocal()
        );
    ...
    public Adult_MemberEntity memberDTOToEntity(Adult_MemberDTO dto) {
        ...
        return Adult_MemberEntity.builder()
                ...
                .firstNameLocal(dto.getFirstNameLocal())
                .fatherNameLocal(dto.getFatherNameLocal())
                .grandFatherNameLocal(dto.getGrandFatherNameLocal())
                .motherFullNameLocal(dto.getMotherFullNameLocal())
                ...
                .spouseMembershipNumber(dto.getSpouseMembershipNumber())
