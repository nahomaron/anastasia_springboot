...
@Component
public class MemberRegistrationSubmittedProcessor implements NotificationProcessor {

    private final EmailNotificationService emailService;
    private final InAppNotificationService inAppService;

    public MemberRegistrationSubmittedProcessor(EmailNotificationService emailService,
    ...
    public NotificationType getType() {
        return NotificationType.MEMBER_REGISTRATION_SUBMITTED;
    }

    @Override
    public void process(NotificationEvent event) {
        emailService.sendEmail(event, "New Member Registration Submitted", EmailTemplateName.NOTIFICATION);
